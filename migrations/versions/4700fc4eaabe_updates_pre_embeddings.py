...
def upgrade():
    ...
    # Drop mentor_profiles cascade to fix DETAIL:  constraint mentorship_sessions_mentor_id_fkey on table mentorship_sessions depends on table mentor_profiles
    # HINT:  Use DROP ... CASCADE to drop the dependent objects too.
    #op.drop_table('mentor_profiles', cascade=True)
    # TypeError: Additional arguments should be named <dialectname>_<argument>, got 'cascade'
